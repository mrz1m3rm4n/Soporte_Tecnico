...
<?php if(isset($_SESSION['usuario'])) :?>
	<?php include_once 'cabecera.php' ?>
		...
		<div class="contenedor">
			...
			<?php
				$gnegocio_edit  = ConseguirGNegocio($db, $_GET['id_gnegocio']);
				if (!isset($gnegocio_edit['id_gnegocio'])) { 
					echo "<script>location.href='index.php';</script>";
				}
			?> 

			<form action="logs/guardar-gnegocio.php?editar=<?=$gnegocio_edit['id_gnegocio']?>" method="POST">
				<input type="text" name="gironegocio" autofocus="autofocus" class="input" value="<?=$gnegocio_edit['gironegocio']?>"> 
